    ...
    <div class="px-2">
        <div class="mt-10">
            <div class="pb-4 mb-4 font-semibold border-b dark:border-gray-600">
                <div class="flex items-start lg:flex-row lg:items-center justify-between flex-col-reverse">
                    ...
                    @foreach ($modules as $module)
                        <div class="grid grid-cols-12">
                            ...
                            <div class="col-span-12  md:col-span-9 border dark:border-gray-600">
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 px-3 py-4 gap-x-0 gap-y-4">
