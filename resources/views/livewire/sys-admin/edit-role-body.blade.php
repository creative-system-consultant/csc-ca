    ...
    <div class="px-2">
        <div class="mt-10">
            <div class="pb-4 mb-4 font-semibold border-b dark:border-gray-600">
                <div class="flex flex-col-reverse items-start justify-between lg:flex-row lg:items-center">
                    ...
                    @foreach ($modules as $module)
                        <div class="grid grid-cols-12">
                            ...
                            <div class="col-span-12 border md:col-span-9 dark:border-gray-600">
                                <div class="grid grid-cols-2 px-3 py-4 md:grid-cols-3 lg:grid-cols-3 gap-x-0 gap-y-4">
